            ...
            <div class="main-content-inner">
                ...
                <div class="card mt-5">
                    <div class="card-body">
                        ...
                        <div>
                            <!-- dashboard item here -->
                            <embed type="text/html" src="https://surveyor-jr.maps.arcgis.com/apps/opsdashboard/index.html#/4745c06d54ba4ec0b40d4644fc896127" width="100%" height="400">
                        </div>
                    </div>
                </div>
                ...
                <!-- dashboard item area end -->
                <div class="alert alert-info" role="alert" style="text-align:center;">
                Click on the expand icon at the top right corner of each tab to expand the visual displays
                </div>
                <!-- dashboard item area start -->
                <div class="card mt-5">
                    <div class="card-body">
